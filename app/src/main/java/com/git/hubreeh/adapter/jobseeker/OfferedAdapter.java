...
public class OfferedAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    Activity context;
    List<JobModel.OfferedBean> bookedModels = new ArrayList<>();

    public OfferedAdapter(Activity context, List<JobModel.OfferedBean> bookedModels) {
