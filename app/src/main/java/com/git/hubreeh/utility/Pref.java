...
public class Pref {
    ...
    private static final String PrefDB = "hubreeh";
    private static final String PerPrefDB = "perhubreeh";
    ...
    public static void SaveDeviceToken(Context context, String Value) {
        SharedPreferences sp = context.getSharedPreferences("hubreehdevicetoken.txt", MODE_PRIVATE);
        SharedPreferences.Editor editor = sp.edit();
