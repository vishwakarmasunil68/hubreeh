...
import com.git.hubreeh.adapter.jobseeker.AppliedAdapter;
...
public class FragmentMyJobsApplied extends Fragment {
    View view;
    @BindView(R.id.recycler_booked)
    RecyclerView recyclerBooked;
    Unbinder unbinder;
    AppliedAdapter mAdapter;
    List<JobModel.AppliedBean> appliedBeans = new ArrayList<>();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_myjobs_applied, container, false);
        ...
        mAdapter = new AppliedAdapter(getActivity(), appliedBeans);
        ...
        call.enqueue(new Callback<JobModel>() {
            ...
            public void onResponse(Call<JobModel> call, Response<JobModel> response) {
                ...
                if (response.body().getStatus() == 1) {
                    appliedBeans.clear();
                    appliedBeans.addAll(response.body().getApplied());
