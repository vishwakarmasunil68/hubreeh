...
public class MembershipProfessionalFragment extends Fragment {
    View view;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view=inflater.inflate(R.layout.fragment_membership_professional,container,false);
        initialize();
    ...
    private void prepareData() {
        membershipPointsModels.clear();
        MembershipPointsModel model=new MembershipPointsModel("100 Skills");
        membershipPointsModels.add(model);
        model=new MembershipPointsModel("Custom Cover Photo");
        membershipPointsModels.add(model);
        model=new MembershipPointsModel("20 Employeers Followings");
        membershipPointsModels.add(model);
        ...
        membershipPointsModels.add(model);
        model=new MembershipPointsModel("300 Bid Per Month");
        membershipPointsModels.add(model);
        model=new MembershipPointsModel("15 External Invoicing");
        membershipPointsModels.add(model);
